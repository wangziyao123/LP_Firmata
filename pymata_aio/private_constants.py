...
class PrivateConstants:
    ...
    # set infra-red pin and T/R mode
    DFROBOT_MESSAGE = 0x0D

    SUB_MESSAGE_IR = 0x00
    SUB_MESSAGE_IR_CONF = 0x00
    SUB_MESSAGE_IR_GET_KEY = 0x01

    SUB_MESSAGE_NEOPIXEL = 0x05

    SUB_MESSAGE_NFC = 0x06
    SUB_MESSAGE_NFC_CONF = 0x00
    SUB_MESSAGE_NFC_SCAN = 0x01

    SUB_MESSAGE_DHT = 0x0D
